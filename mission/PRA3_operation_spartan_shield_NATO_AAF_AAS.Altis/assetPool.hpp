...
class templateWest : templateVehicle {
    side = "WEST";
};

class templateEast : templateVehicle {
    side = "EAST";
};

class templateIndependent : templateVehicle {
    side = "GUER";
};
...
class AssetPool {
    ...
    // -- Blufor -- //
    // Cars
    class vr_hunter_0 : templateWest {
        respawnTime = 300;
        ticketValue = 25;
    };
    class vr_hunter_1: vr_hunter_0 {};

    class vr_hunterHMG_0 : templateWest {
        respawnTime = 600;
        ticketValue = 50;
    };
    ...
    // Air
    class vr_ghosthawk_0 : templateWest {
        respawnTime = 600;
        ticketValue = 50;
    };
    ...
    // -- AAF -- //
    // Car
    class vr_strider_0 : templateIndependent {
        ticketValue = 20;
        respawnTime = 300;
    };
    ...
    // Air
    class vr_mohawk_0 : templateIndependent {
        respawnTime = 600;
        ticketValue = 50;
    };
    class vr_mohawk_1: vr_mohawk_0 {};

    class vr_hellcat_0 : templateIndependent {
        respawnTime = 900;
        ticketValue = 75;
    };
