...
class PRA3_UI_DeploymentManagement : RscControlsGroupNoScrollbars {
    ...
    class Controls {
        ...
        class SpawnPointList : PRA3_RscListNBox {
            ...
            onLBSelChanged = "['PRA3_UI_RespawnScreen_SpawnPointList_onLBSelChanged', []] call PRA3_fw_fireEvent;";
        };
        class DeployButton : PRA3_RscButtonMenu_Colored {
            ...
            h = PY(6);
            colorText[] = {0,0,0,1};
            action = "['PRA3_UI_RespawnScreen_DeployButton_action', []] call PRA3_fw_fireEvent;";
        };
    };
};
